[elastalink-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [elastalink-3f10] container is NOT running**.

.. tip::
   You must have your [elastalink-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   http://localhost:49689/iot-failure-elastalink.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[elastalink-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/elastalink-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46597, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=35963, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=44235, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=41465, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43895, HPDEHOST=127.0.1.1, HPDEPORT=44689, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34599

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1571-elastalink-3f10,solution_preprocessing_dag-elastalink-3f10, python-preprocess-3487-elastalink-3f10,solution_preprocessing_dag-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
